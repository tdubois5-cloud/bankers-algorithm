This program uses Banker’s Algorithm for deadlock avoidance in a system with multiple processes and resource types. 
...
If not, it prints that the system is not in a safe state.
